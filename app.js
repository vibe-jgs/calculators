...
function renderComparisonDashboard(base, opt, opt2) {
  ...
  <table class="strategy-table" style="font-size: 0.95rem;">
    ...
    <tbody>
      ...
      <tr>
        <td class="strategy-table__label">Total Taxable Income<br><small style="font-weight:400;color:var(--text-muted)">Base + RSU + CGT - Deductions</small></td>
      ...
      <tr class="strategy-table__row--total" style="border-top: 2px solid var(--border-medium);">
        <td class="strategy-table__label" style="color: var(--text-primary);">Total Tax Bill to Pay (End of Year)<br><small style="font-weight:400;color:var(--text-muted)">Liability - Auto PAYG Withheld</small></td>
      ...
      <tr class="strategy-table__row--total" style="background: rgba(255,255,255,0.02);">
        <td class="strategy-table__label" style="color: var(--text-primary);">Total Cash Required<br><small style="font-weight:400;color:var(--text-muted)">Extra Super Contribution + Tax Bill</small></td>
